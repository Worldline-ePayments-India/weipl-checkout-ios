...
#ifndef WEIPL_CHECKOUT_SWIFT_H
#define WEIPL_CHECKOUT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="weipl_checkout",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC14weipl_checkout10WEIPLSwift")
@interface WEIPLSwift : NSObject
- (void)loadSDK;
...
@class CXCall;
SWIFT_CLASS("_TtC14weipl_checkout24WLCheckoutViewController")
@interface WLCheckoutViewController : UIViewController <CXCallObserverDelegate, UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKUIDelegate>
